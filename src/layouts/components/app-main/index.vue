<template>
  <maximize-button v-show="maximize" />
...
import MaximizeButton from './components/maximize-button.vue';
import AppTabs from '@/layouts/components/app-tabs/index.vue';
import AppFooter from '@/layouts/components/app-footer/index.vue';
